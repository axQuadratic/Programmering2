# A single line of flavour text may not exceed 60 characters
location_text = {
    "empty": [
    ...
    "asteroids": [
        ["This route travels through a somewhat hazardous",
         "asteroid field."],
        ["This route is hazardous for sublight travel."],
        ["There are space rocks in this region.",
         "The ship's hull receives minor damage during traversal."]
    ],
    "orbit": [
        ["The ship enters low orbit of a local celestial body."],
        ["The nearby planetary body is quickly surveyed",
         "and catalogued in the ship's databanks."],
    ...
    "entry_point": [
        ...
        ["The Hyperdrive cannot pass through the same route",
         "twice in a row."],
        ["The ship exited hyperspace in this location.",
         "No return is possible."]
    ],
    "exit_point": [
        ["A hyperlane entry point! It should be safe for",
         "ship travel."],
        ["A hyperlane entry point is present in this sector."],
        ["A stable hyperspace route may be established",
         "from this location."]
    ]
}

death_text = [
    ["This ship's journey has ended, but this is not the end.",
     "Another vessel will follow in its footsteps,",
     "and perhaps go yet further."],
    ["Once again, a vessel falls to the Dark Sector's chaos.",
     "However, a successor will always come, and someday",
